...
const Features = () => {
    ...
    return (
        <section id="features" className="py-20 md:py-32 relative overflow-hidden bg-gradient-to-b from-white to-slate-50">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium bg-green-100 text-green-700 border border-green-200">
                ...
                {/* Stats Section */}
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20 p-8 rounded-3xl bg-white shadow-xl shadow-slate-200/50 border border-slate-200">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {features.map((feature, index) => (
                        <div
                            key={index}
                            className={`group relative p-6 rounded-2xl border-2 transition-all duration-500 ${feature.bgColor} ${feature.borderColor} hover:shadow-xl hover:shadow-slate-300/50 ${feature.hoverBg} hover:-translate-y-2`}
                        >
                            {/* Icon */}
                            ...
                            {/* Hover Arrow */}
                            <div className="absolute bottom-6 right-6 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0 text-green-600">
                ...
                <div className="mt-20 grid lg:grid-cols-2 gap-12 items-center">
                    <div className="relative">
                        ...
                        {/* Floating Card */}
                        <div className="absolute -bottom-6 -right-6 p-4 rounded-2xl shadow-xl bg-white border border-slate-200">
